...
* the workbook it writes has the same eight sheets as the notebook's,
...
def test_workbook_matches_the_notebook_shape() -> None:
    """Same eight sheets the notebook writes, in the same order."""
    ...
    check("eight sheets, matching the notebook", wb.sheetnames == expected,
          str(wb.sheetnames))
